            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('bar/beverage/save') }}" method="POST">
                            @csrf
                            <div class="row"> 
                                <div class="col-sm-6"> 
                            ...
                            <div class="row"> 
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control  @error('unit') is-invalid @enderror" value="{{ old('unit') }}" name="unit">
                                ...
                                <div class="col-sm-6"> 
                                    ...
                                    <input type="text" name="uprice" class="form-control  @error('upricenit') is-invalid @enderror" value="{{ old('uprice') }}" placeholder="enter unit price">
                                </div>
                            </div>
                            </div>
                            <br>
        ...
        <div id="edit_beverage" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <br>
                    <div class="modal-body">
                        <form action="{{ route('bar/beverage/update') }}" method="POST">
                            @csrf
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="{{ route('bar/beverage/delete') }}" method="POST">
                                @csrf
