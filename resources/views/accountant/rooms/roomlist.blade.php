...
@section('content')
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- <option value="{{ $result[0]->roomtype }}" {{ ( $result[0]->roomtype == $result[0]->roomtype) ? 'selected' : '' }}>{{ $result[0]->roomtype }} </option> --}}
                                            <option value="PUBLIC">PUBLIC</option>
                                            <option value="VIP">VIP</option>
                                            <option value="VVIP">VVIP</option>
                                        </select>
                                ...
                                <div class="col-sm-6"> 
                                    <label>Room Area</label>
                                    <input class="form-control" type="text" name="roomarea" id="roomarea" value=""/>
                                </div>
                            </div>
                            <div class="row"> 
                                <div class="col-sm-6"> 
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                    <label>Status</label>
                                    <select class="select" name="status" id="r_status">
                                        @foreach ($status_room as $status )
                                        <option value="{{ $status->type_name }}">{{ $status->type_name }}</option>
                                        @endforeach
                                    </select>
    ...
    <script>
        $(document).on('click','.roomUpdate',function()
        {
            ...
            $('#roomarea').val(_this.find('.roomarea').text());
